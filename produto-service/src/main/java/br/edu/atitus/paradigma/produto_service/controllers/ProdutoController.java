...
public class ProdutoController {
	...
	public ResponseEntity<ProdutoEntity> getProduto(
			...
			@RequestHeader(required = false) String usuario) throws Exception{
		...
		produto.setAmbiente("Produto-service rodando na porta: " + porta + " - " + cambio.getAmbiente() + "Usuario:" + usuario);
